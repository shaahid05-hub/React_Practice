...
function Login() {
    ...
    let [errmail,setErrmail] = useState('')
    ...
    let valid = true
      ...
      if (email.trim() == '') {
        setErrmail('Email is required')
        valid = false
      } else if(!email.includes('@')){
        setErrmail('@ is required')
        valid = false
      }
      else if(!email.includes('.')){
        setErrmail('. is required')
      ...
      if (pass.trim() == '') {
        ...
        setErrpass('Password should be min. of five characters')
        valid = false
      }
      else {
        setErrpass('')
...
<form className="form border ">
    <div className="flex-column">
      ...
      <div className="inputForm"> 
        ...
        <input type="email" className="input" onChange={(e)=>{setEmail(e.target.value)}} placeholder="Enter your Email"/>
      </div>
    ...
    <div className="flex-column">
      ...
      <div className="inputForm">
        ...
        <input type="password" className="input" placeholder="Enter your Password" onChange={(e)=>{setPass(e.target.value)}}/>
